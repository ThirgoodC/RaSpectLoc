...
The source code for this tutorial is in the cvssp_rviz_plugins
...
with "Teleop" in it (here it is "cvssp_rviz_plugins"):
...
- not properly referencing the library file (like
  libcvssp_rviz_plugins.so) from plugin_description.xml.
