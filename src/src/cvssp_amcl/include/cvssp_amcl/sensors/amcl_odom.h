...
class AMCLOdom : public AMCLSensor
{
  ...
  public: void SetCollideMult(double w);

  // Update the filter based on the action model.  Returns true if the filter
  // has been updated.
  public: virtual bool UpdateAction(pf_t *pf, map_t* map, AMCLSensorData *data);
  ...
  // Colission Parameters
  private: double collide_mult;
};
