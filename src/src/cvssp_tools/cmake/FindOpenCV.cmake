...
#get the special prefix if not 
message("Using Simon's FindOpenCV")
set(OpenCV_Config_Search
	/opt/opencv/opencv-2.4.11/build_14.04_nocuda/install/share/OpenCV
	/opt/compiledLibs/opencv-2.4.11/build_14.04_nocuda/install
	/opt/compiledLibs/opencv-2.4.11/build_14.04_cuda/install
	#/vol/vssp/signsrc/externalLibs/openCV/opencv-3.0.0/build_14.04_nocuda
	/vol/vssp/drones/libraries/OpenCV/opencv-2.4.9/build_14.04_nocuda
	/home/footstool/Libraries/opencv-2.4.11/build_14.04_cuda
	/home/footstool/Libraries/opencv-2.4.11/build_14.04_nocuda
	)
	
#add footstool/home path depending on 32 or 64 bit
if(CMAKE_CL_64)
list(APPEND OpenCV_Config_Search D:/API/opencv_svn/opencv/Build/x64)
list(APPEND OpenCV_Config_Search C:/lib/OpenCV/Win64)
else()
list(APPEND OpenCV_Config_Search D:/API/opencv_svn/opencv/Build/win32)
list(APPEND OpenCV_Config_Search C:/lib/opencv)
endif()

set(OpenCV_Config_suffix
	build
	)

message(STATUS "${OpenCV_Config_Search}")
FIND_PATH(OpenCV_DIR
	NAMES OpenCVConfig.cmake
	PATHS
	${OpenCV_Config_Search}
	PATH_SUFFIXES
	${OpenCV_Config_suffix}
	DOC "OpenCV root dir"
)
...
if(EXISTS "${OpenCV_DIR}")
		...
		message(STATUS "Using config file ${OpenCV_DIR}/OpenCVConfig.cmake")
		...
		message(STATUS "Can't find config file ${OpenCV_DIR}/OpenCVConfig.cmake")
...
##====================================================
## Backward compatibility - Removed by Simon
##----------------------------------------------------
#if(OpenCV_FOUND)
